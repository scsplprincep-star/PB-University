...
const STUDENT_COLUMNS = [
    ...
    { text: "State Name", datafield: "state_name", width: 180 },
    {
        text: "Status",
        datafield: "is_status",
        width: 180,
...
function List_state_master() {
    ...
    const loadStudents = useCallback(async () => {
        try {
            ...
            const { data: payload } = await api.get(
                "api/state_master_Contoller/state_master_select_all",
    ...
    const handelonView = (student) => {
        ...
        navigate(`/State_Master?viewid=${student.sm_id}`);
    };
    ...
    const handelonEdit = (student) => {
        ...
        navigate(`/State_Master?id=${student.sm_id}`);
    };
    ...
    const handelondelete = async (student) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire("Deleted!", "The State record has been deleted.", "success");
    ...
    const deleteStudent = async (student) => {
        try {
            await api.get(
                "api/state_master_Contoller/state_master_delete",
                {
                    params: {
                        id: student.sm_id,
                        create_By: userid,
...
export default List_state_master